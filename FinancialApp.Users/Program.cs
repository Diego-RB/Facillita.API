...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Facillita.Users API", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Facillita.Users V1");
